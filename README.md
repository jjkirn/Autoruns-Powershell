...
<ol>
  <li>Add directory <b>"\ARSQL\"</b> then add the module:</li>
    <ol>
      <li><b>AR-SQL.psm1</b></li>
    </ol>
  <li>Add directory <b>"\SendSlackMsg\"</b> then add the module:</li>
    <ol>
      <li><b>Send-Slack-Msg.psm1</b></li>
    </ol>
</ol>
